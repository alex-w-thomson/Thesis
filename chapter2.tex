...
\begin{align*}
 \itlw{p}{0}{2}{w} &= H^p (w) \text{ for } 0<p<\infty, \quad w\in A_\infty, 

 \itlw{p}{0}{2}{w} &= L^p(w) \simeq H^p(w) \text{ for } 1<p<\infty, \quad w\in A_p, 

 \itlw{p}{s}{2}{w} &= \dot{W}^{s,p}(w) \text{ for } 1<p<\infty, \quad w\in A_p,
\end{align*}
...
To prove Theorem \ref{thm:Nikolskij:Lorrentz:weighted} we make use of the following Lemma.

\begin{lemma}\label{coro:2:12(1)_Lorrentz}
